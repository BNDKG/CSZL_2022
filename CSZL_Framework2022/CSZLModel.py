...
class CSZLModel(object):
    ...
    def LGBmodeltrain(self,featurepath):
        ...
        x_train,y_train=self.LGBdatasetprepar(featurepath)
    ...
    def LGBmodelpredict(self,featurepath,modelpath):
        ...
        predictname=modelpath+'_0_predict.csv'
        ...
        train2=x_train.copy(deep=True)

        for counter in range(4):
            modelpath_new=modelpath+'_'+str(counter)+".pkl"
            predictpath_new=modelpath+'_'+str(counter)+"_predict.csv"
